...
package org.cyanogenmod.doze.armani;
...
public abstract class ArmaniSensor {

    private static final String TAG = "ArmaniSensor";
    ...
    public ArmaniSensor(Context context, int type) {
        mContext = context;
        mType = type;
